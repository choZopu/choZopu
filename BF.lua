                 repeat
                                ...
                                local win = Flux:Window("Pully", "Blox Fruit",_G.Color, Enum.KeyCode.RightControl)
                                local tab = win:Tab("AutoFarm⚔️")
                                local Stats = win:Tab("Stats❤️",)
                                local e = win:Tab("Setting AutoFarm⚙️")
